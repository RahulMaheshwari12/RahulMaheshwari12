...
- 🏓 **2x State Level Table Tennis Player** — same competitive drive, different arena
- 🔭 Actively seeking **Data Science / AI Engineer internships**
- ⚡ Fun fact: I debug agents at midnight and enjoy it
...
- 🗄️ Complete **SQL data pipeline** using SQLite3 — demographics, clinical features & multi-factor risk combinations
- 🤖 **PyTorch ANN** (BatchNorm + Dropout + LeakyReLU) with WeightedRandomSampler — **ROC-AUC: 0.9538 | 91.35% recall**
- 🌐 **Threshold tuned at 0.4** for medical recall; deployed via **Flask on Render**
...
> End-to-end predictive pipeline on 304,000 customer records

- 🎯 **88% recall** and **Class-1 F1-score: 0.69** using optimized LightGBM ensemble
- 🎨 **Flask dashboard** with real-time animated SVG risk gauges & drag-and-drop batch CSV upload
...
> Binary classification pipeline on LendingClub financial data

- 🛡️ **Data leakage prevention** — dropped 25+ post-origination features
- 🎯 **ROC-AUC: 0.71** with business-driven threshold tuning

---

### 🎬 [Netflix Data Analysis](https://github.com/RahulMaheshwari12/Netflix-data-analysis)
`Python` `Pandas` `Seaborn` `Matplotlib`
> Exploratory analysis of 8,800+ Netflix titles
